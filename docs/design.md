...
- Changing to the next map region invalidates the previous region's accepted path immediately; no old walking, jumping, breaking, or placement waypoint may run while the replacement path is being planned.
